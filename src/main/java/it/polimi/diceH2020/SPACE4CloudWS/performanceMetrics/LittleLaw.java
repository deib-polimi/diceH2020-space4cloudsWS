...
public class LittleLaw {
    ...
    private static double invertForThroughput (int users, double responseTime, double thinkTime) {
    ...
    public static double computeThroughput (double responseTime, SolutionPerJob solutionPerJob) {
        int numUsers = solutionPerJob.getNumberUsers ();
        double thinkTime = solutionPerJob.getJob ().getThink ();
        return invertForThroughput (numUsers, responseTime, thinkTime);
    }
}
